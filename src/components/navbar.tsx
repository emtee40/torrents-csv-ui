    ...
    return (
      <nav class="navbar navbar-dark bg-dark p-1 shadow">
        ...
        <div class="navbar-nav ml-auto mr-2">
          <a class="nav-item nav-link" href={repoUrl}><svg class="icon icon-github"><use xlinkHref="#icon-github"></use></svg></a>
        </div>
        {this.searchForm()}
      </nav>
    );
        ...
        <div class="input-group w-100">
          ...
          <div class="input-group-append">
            ...
            <button class="btn btn-secondary border-0 rounded-right no-outline" type="submit">
              <svg class="icon icon-search"><use xlinkHref="#icon-search"></use></svg>
            </button>
          </div>
        </div>
      </form>
